...
#include<W5100h>					/* 定义W5100的寄存器地址、状态 */
#include"REG51.h"
typedef unsigned char SOCKET;

/*------------------------------------------------------*/
sbit     W5100_RST=P1^1;//RST
sbit     SPI_CS= P1^0;  //SCS
sbit     SPI_SCK= P1^2;	//SCLK
sbit     SPI_SO= P1^3;	//MISO
sbit     SPI_SI= P1^4;	//MOSI
//W5100只用到上面的5个此脚
/*------------------------------------------------------*/
...
unsigned char Phy_Addr[6]={0x00,0x08,0xDC,0x01,0x02,0x23};  			/* Physical Address */
unsigned char IP_Addr[4]={192,168,0,105};				/* Loacal IP Address */

unsigned char S0_Port[2]={0x13,0x88}; 			/* Socket0 Port number 5000 */
unsigned char S0_DIP[4]={192,168,0,100};				/* Socket0 Destination IP Address */
